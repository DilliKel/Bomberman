...
Este projeto é uma implementação do clássico jogo Bomberman, desenvolvido como parte do trabalho final da disciplina de Computação Gráfica. O jogo apresenta uma interface gráfica 2D usando a biblioteca Kaboom.js.
